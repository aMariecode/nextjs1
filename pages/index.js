    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <article className={styles.post}>
          ...
          Favourite Music are in genre of rock and emo. <br/> I am a foodie person.<br/> I am taking up IT because honestly speaking computers were my weakness,<br/> when I was in high school since it is just a public school they cannot afford to provide computers for the students. <br/>Only private schools could offer computer courses at that time. Secondly, we know nowadays it is the most in-demand in the field.
